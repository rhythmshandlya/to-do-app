...
document.querySelector('.todo-form').addEventListener('submit', (e) => {
  ...
  allTodos[allTodos.length - 1].querySelector('i').addEventListener('click', deleteTodo);
  allTodos[allTodos.length - 1].querySelector('input').addEventListener('click', markTodoAsDone);
  activeCount++;
  refreshActiveCount();
  formInput.value = '';
});
